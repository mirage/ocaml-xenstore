...
module Introspect = struct
  ...
  let read t (perms: Perms.t) (path: Protocol.Path.t) =
    ...
    | "default" :: "number-of-registered-watches" :: [] -> string_of_int (!Quota.maxwatch)
    | "default" :: "number-of-active-transactions" :: [] -> string_of_int (!Quota.maxtransaction)
    | "default" :: "number-of-queued-watch-events" :: [] -> string_of_int (!Quota.maxwatchevent)
  ...
  let write t creator perms path value =
    ...
    | "default" :: "number-of-registered-watches" :: [] -> Quota.maxwatch := int_of_string value
    | "default" :: "number-of-active-transactions" :: [] -> Quota.maxtransaction := int_of_string value
    | "default" :: "number-of-queued-watch-events" :: [] -> Quota.maxwatchevent := int_of_string value
    | "number-of-entries" :: domid :: [] ->
...
let _ = Mount.mount (Protocol.Path.of_string "/tool/xenstored/quota") (module Introspect: Tree.S)
