...
val reply: Store.t -> Limits.t option -> Perms.t -> Connection.t -> Xenstore.Protocol.Header.t -> Xenstore.Protocol.Request.t -> (Xenstore.Protocol.Response.t * Transaction.side_effects) Lwt.t
