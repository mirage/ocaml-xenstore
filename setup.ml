...
(* OASIS_START *)
(* DO NOT EDIT (digest: 3ece1d200428e388f982d9679bdb5476) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("lwt", None);
                           InternalLibrary "xenstore";
                           FindlibPackage ("xeneventchn", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                   ...
                   {
                      lib_modules = ["Xs_transport_unix"; "Dom0"; "Xenstore"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "xenstore";
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "^\250\145y\017\209\224\151?_<U\202~Q\024";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
