...
(* OASIS_START *)
(* DO NOT EDIT (digest: d03a05106dbccce5006bb0b556697717) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          sections =
            [
               ...
               Library
                 ({
                     cs_name = "xenstore_server_domain";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {
                      lib_modules = ["Xs_transport_domain"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "xenstore";
                      lib_findlib_name = Some "domain";
                      lib_findlib_containers = [];
                      });
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "xenstore";
                           InternalLibrary "xenstore_server";
                           InternalLibrary "xenstore_server_domain";
                           FindlibPackage ("cstruct", None);
                           FindlibPackage ("mirage", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
     ...
     oasis_version = "0.3.1";
     oasis_digest = Some "KN\227\163\242\183\194\225\203\199\029\020\026nyx";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
