...
(* OASIS_START *)
(* DO NOT EDIT (digest: ed32a5dd1cab7de00d32ac10fe039430) *)
(*
...
(* # 21 "/local/scratch/djs/.opam/4.00.1/build/oasis.0.3.0/src/plugins/custom/CustomPlugin.ml" *)
...
let setup_t =
  {
     ...
     oasis_version = "0.3.0";
     oasis_digest =
       Some "_\206\210\221\216\178\230\192\204\239\023\165}}0\204";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
