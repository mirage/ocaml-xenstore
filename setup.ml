...
(* OASIS_START *)
(* DO NOT EDIT (digest: 490e0319a59e55ba59a5ecf0db9170f1) *)
(*
...
let setup_t =
  {
     ...
     doc = [("xenstore", OCamlbuildDocPlugin.doc_build "lib")];
     ...
     clean_doc = [("xenstore", OCamlbuildDocPlugin.doc_clean "lib")];
     distclean = [];
     distclean_test =
       [
          ("xs_test",
