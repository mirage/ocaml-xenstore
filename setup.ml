...
(* OASIS_START *)
(* DO NOT EDIT (digest: f7abfe8fd2878a23521d7330b7bc5557) *)
(*
...
let setup_t =
  {
                 ...
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "xenstore";
                           InternalLibrary "xenstore_client_unix";
                           FindlibPackage ("threads", None);
                   ...
                   {exec_custom = true; exec_main_is = "client_test.ml"; });
               Executable
                 ({
                     cs_name = "xs_test";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "I\184\030\253\136\005\242\001\221\142jZ\023\142Ig";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
