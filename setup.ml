...
(* OASIS_START *)
(* DO NOT EDIT (digest: 435bdc7d8278283cfe1423f4e05f713a) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "server_xen.ml"; });
               Executable
                 ({
                     cs_name = "xs_test";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.3.1";
     oasis_digest = Some "\b\208\015\017\130^m\014V\159\249E\129\230\170O";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
