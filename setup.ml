...
(* OASIS_START *)
(* DO NOT EDIT (digest: 587e23589126cce75898e6ab461f40ad) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Xs_protocol"; "Xs_handle"; "S"];
                      lib_pack = false;
     ...
     oasis_version = "0.4.1";
     oasis_digest =
       Some "\197\011\028\159\246\028\251\159\245\209\141\014\015\147\131)";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
