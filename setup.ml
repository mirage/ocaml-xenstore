...
(* OASIS_START *)
(* DO NOT EDIT (digest: 60e72c2acead461e5e638ba6449f615c) *)
(*
...
let setup_t =
  {
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("lwt.unix", None);
                           InternalLibrary "xenstore";
                           InternalLibrary "xenstore_xenctrl"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "~\019È\txT\159& ¯æ®î[,{";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
