...
(* OASIS_START *)
(* DO NOT EDIT (digest: 297ac16e377094110565152bc170e501) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "xenstore_core";
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "xstest";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "xenstore_legacy_unix";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   },
                   {
                      ...
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "xenstore_core";
                      lib_findlib_name = Some "legacy_unix";
                      lib_findlib_containers = []
                   });
               Executable
                 ({
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "f\255\180\n\136j\027\142c\214R\199\216\177\194X";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
