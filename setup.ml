...
(* OASIS_START *)
(* DO NOT EDIT (digest: 7844da7a0b74cdfbebb47a7708a3f5dc) *)
(*
...
(* # 21 "/home/avsm/.opam/4.00.1+mirage-xen/build/oasis-mirage.0.3.0/src/plugins/custom/CustomPlugin.ml" *)
...
let setup_t =
  {
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage
                             ("cstruct", Some (OASISVersion.VLesser "0.6.0"));
     ...
     oasis_version = "0.3.1";
     oasis_digest = Some "\151\1484\205\028S&o\2000\174G\171:\b.";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
