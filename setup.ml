...
(* OASIS_START *)
(* DO NOT EDIT (digest: 5a3ef540c88f06b41fc029d6b303112b) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Xs_protocol"; "Handle"; "Client"; "S"];
                      lib_pack = true;
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Sockets"; "Xs_transport"];
                      lib_pack = false;
                      lib_internal_modules = [];
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "\001\236x\152\199\242d\230\146\157\002fz~\150f";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
