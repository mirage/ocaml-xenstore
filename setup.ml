...
(* OASIS_START *)
(* DO NOT EDIT (digest: 234942efa6a4de0648b614b281326971) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Xs_client_lwt"; "Xs_server_lwt_unix"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "xenstore";
                      lib_findlib_name = Some "lwt_unix";
                      lib_findlib_containers = []
                   });
               Library
                 ({
               ...
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "xstest.ml"});
               Executable
                 ({
                     cs_name = "server_test";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "xenstore";
                           InternalLibrary "xenstore_server";
                           InternalLibrary "xenstore_lwt_unix";
                           FindlibPackage ("oUnit", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "\216\254\237\174(\221z\162\137\245 \205\182Q\161H";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
