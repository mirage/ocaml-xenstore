...
(* OASIS_START *)
(* DO NOT EDIT (digest: d5ed80570ff62802a136bc49e68b790f) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Userspace"; "Domains"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "xenstore";
                      lib_findlib_name = Some "userspace";
                      lib_findlib_containers = []
                   });
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("lwt.unix", None);
                           InternalLibrary "xenstore";
                           InternalLibrary "xenstore_userspace";
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Kernelspace"; "PBuffer"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "xenstore";
                      lib_findlib_name = Some "kernelspace";
                      lib_findlib_containers = []
                   });
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "xs.ml"});
               Executable
                 ({
                     cs_name = "domain_watcher";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = true; exec_main_is = "domain_watcher.ml"})
            ];
     ...
     oasis_version = "0.4.5";
     oasis_digest =
       Some "\026\208\152C\164\180\245\203\002\230\240t?\177Q\148";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
